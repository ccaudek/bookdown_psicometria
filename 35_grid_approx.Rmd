...
In altri termini, è possibile ottenere la distribuzione posteriore per via analitica solo per alcune specifiche combinazioni di distribuzioni a priori a verosimiglianza, il che sembra limitare considerevolmente la flessibilità della modellazione. 
Tuttavia, con la maggiore potenza dei computer odierni, una stima della distribuzione a posteriori può essere ottenuta con metodi numerici, i metodi di campionamento  Monte-Carlo Markov-Chain (MCMC). Tali metodi quali costituiscono una potente e praticabile alternativa per la costruzione della distribuzione a posteriori per modelli complessi e ci consentono di decidere quali distribuzione a priori e quali distribuzioni di verosimiglianza usare sulla base di considerazioni teoriche, senza preoccuparti dei limiti dei metodi analitici attualmente disponibili. 
