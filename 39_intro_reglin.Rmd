...
```{r, echo=FALSE}
# Per descrivere cosa fa l'analisi di regressione, iniziamo a considerare alcuni dati. Per semplicità, li simuliamo:
# set.seed(1234)
# n <- 100
# x <- round(rnorm(n, 4, 1), 1)
# y <- round(5 + 5 * x + rnorm(n, 0, 2), 1)

# Salviamo questi dati nel data.frame `d` di cui stampiamo le prime righe:
# d <- data.frame(x, y)
# head(d)
```
