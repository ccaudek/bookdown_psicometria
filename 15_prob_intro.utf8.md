...
- La probabilità di un evento deve essere compresa tra 0 e 1, dove 0 significa che l'evento è impossibile e non può accadere, e 1 significa che l'evento è certo che accadrà.

- Per due eventi che si escludono a vicenda, la probabilità che si verifichi l'uno o l'altro è la somma delle loro separate probabilità.

- Due eventi sono indipendenti se e solo se la probabilità del verificarsi di entrambi gli eventi è uguale al prodotto delle probabilità del verificarsi di ciascun evento.

- La somma delle probabilità di tutti i possibili eventi nell'intero spazio campionario deve essere uguale a 1. 

Le definizione precedenti corrispondono al cosiddetto _approccio assiomatico_ messo a punto da Kolmogorov intorno al 1930, il quale è alla base della moderna teoria della probabilità. Gli assiomi di Kolmogorov sono necessari per evitare i paradossi che si possono creare quando si manipolano gli insiemi -- ad esempio, l'utilizzo dell'"l'insieme di tutti gli insiemi" tipicamente conduce ad un paradosso. 
