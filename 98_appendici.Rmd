...
## Proprietà degli stimatori dei minimi quadrati {#propr_coef_min_quad .unnumbered}
...
a &\sim \mathcal{N}\bigg(\alpha, \frac{\sigma^2_{\varepsilon}\textstyle\sum x_i^2}{n \textstyle\sum (x_i-\bar{x})^2} \bigg).\end{aligned}$$
