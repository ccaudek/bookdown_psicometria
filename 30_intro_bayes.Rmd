...
Spesso vogliamo spiegare una parte dei nostri dati, ovvero le variabili dipendenti $D_{DV}$,  nei termini di altre osservazioni, ovvero le variabili indipendenti $D_{IV}$.  Ma è anche possibile trovarsi nella condizione nella quale non ci sono variabili indipendenti ma solo una o più variabili dipendenti $D_{DV}$.
...
$$
I modelli Bayesiani includono una componente aggiuntiva, vale a dire una distribuzione a priori sui valori dei parametri, comunemente scritta come:
