...
```{solution}
Per risolvere tale problema notiamo che l'evento $S = 7$ si verifica in corrispondenza di sei punti elementari dello spazio campionario $\Omega$: \{(1, 6), (2, 5), (3, 4), (4, 3), (2, 5), (6, 1)\}. Dunque,
\begin{equation}
P(S = 7) = \\
