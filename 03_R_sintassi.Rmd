# Sintassi di base {#chapter:sintassi_R}
...
-   Conoscere e sapere usare alcune delle funzioni di base di R.
...
di tasti (`Command + Enter` su Mac OS X e `ctrl + r` in Windows)[^1].
...
[^1]: `ctrl + r` significa premere il tasto `ctrl` e, tenendolo premuto,
    premere il tasto `r` della tastiera
