--- 
title: "PSICOMETRIA"
subtitle: "A.A. 2020/2021"
author: "Corrado Caudek"
description: "Queste dispense contengono il materiale delle lezioni dell'insegnamento Psicometria B000286 (A.A. 2020/2021) rivolto agli studenti del primo anno del Corso di Laurea in Scienze e Tecniche Psicologiche dell'Università di Firenze."
language: italian
bibliography: [biblio_psicom.bib]
biblio-style: "apa"
link-citations: yes
date: "`r Sys.Date()`"
...
Alcuni degli argomenti trattati richiedono delle conoscenze pregresse, soprattutto di tipo matematico. 
Tali conoscenze sono state aggiunte delle appendici di queste dispense. 
concetti elementari di insiemistica). 
