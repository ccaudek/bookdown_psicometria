# Il modello lineare {#chapter:stat_models}
...
[^1]: In seguito, quest'idea è stata completamente screditata.

[^2]: I metodi di stima MCMC costituiscono la modalità usuale per
    ...
    informatico che esula dagli scopi di questo insegnamento.
