...
#>  [9] ggExtra_0.9        ggpubr_0.4.0       papaja_0.1.0.9997  bayesplot_1.8.0   
#> [13] forcats_0.5.1      stringr_1.4.0      dplyr_1.0.4        purrr_0.3.4       
#> [17] readr_1.4.0        tidyr_1.1.2        tibble_3.0.6       ggplot2_3.3.3     
#> [21] tidyverse_1.3.0    here_1.0.1        
#> 
#> loaded via a namespace (and not attached):
#>  [1] fs_1.5.0             lubridate_1.7.9.2    httr_1.4.2          
#>  [4] rprojroot_2.0.2      tools_3.6.3          backports_1.2.1     
#>  [7] bslib_0.2.4          R6_2.5.0             ggdist_2.4.0        
#> [10] DBI_1.1.1            colorspace_2.0-0     withr_2.4.1         
#> [13] tidyselect_1.1.0     downlit_0.2.1        curl_4.3            
#> [16] compiler_3.6.3       cli_2.3.0            rvest_0.3.6         
#> [19] arrayhelpers_1.1-0   xml2_1.3.2           bookdown_0.21.6     
#> [22] sass_0.3.1           scales_1.1.1         ggridges_0.5.3      
#> [25] rappdirs_0.3.3       digest_0.6.27        foreign_0.8-75      
#> [28] rmarkdown_2.6.6      pkgconfig_2.0.3      htmltools_0.5.1.9000
#> [31] dbplyr_2.1.0         fastmap_1.1.0        rlang_0.4.10        
#> [34] readxl_1.3.1         rstudioapi_0.13      shiny_1.6.0         
#> [37] farver_2.0.3         svUnit_1.0.3         jquerylib_0.1.3     
#> [40] generics_0.1.0       jsonlite_1.7.2       distributional_0.2.2
#> [43] zip_2.1.1            magrittr_2.0.1       Rcpp_1.0.6          
#> [46] munsell_0.5.0        abind_1.4-5          lifecycle_0.2.0     
#> [49] stringi_1.5.3        yaml_2.2.1           plyr_1.8.6          
#> [52] grid_3.6.3           promises_1.2.0.1     crayon_1.4.1        
#> [55] lattice_0.20-41      miniUI_0.1.1.1       haven_2.3.1         
#> [58] hms_1.0.0            knitr_1.31           pillar_1.4.7        
#> [61] ggsignif_0.6.0       reprex_1.0.0         glue_1.4.2          
#> [64] evaluate_0.14        data.table_1.13.6    modelr_0.1.8        
#> [67] vctrs_0.3.6          httpuv_1.5.5         cellranger_1.1.0    
#> [70] gtable_0.3.0         assertthat_0.2.1     xfun_0.21           
#> [73] openxlsx_4.2.3       mime_0.9             xtable_1.8-4        
#> [76] broom_0.7.4          coda_0.19-4          rstatix_0.6.0       
