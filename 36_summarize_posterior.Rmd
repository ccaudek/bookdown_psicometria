...
__l'intervallo piùpiccolo__ che contiene la massa di probabilità specificata --
...
Si noti che la media a posteriori di 0.66 è quasi identica a quella che avevamo ottenuto con una distribuzione a priori uniforme (ovvero, 0.67). Ancora più importante è il fatto che, con un campione così grande, l'intervallo di credibilità al 95% diventa piccolissimo: [0.63, 0.69]. Questo vuol dire che, avendo a disposizione un campione sufficientemente grande, siamo piuttosto certi di quali sono i valori plausibili del parametro sconosciuto. E la risposta che troviamo non dipende dalle nostre credenze a priori, anche nel caso in cui, a priori, avevamo delle credenze molto forti (e molto lontane dalla realtà).
