...
Il campione dei 10000 valori a posteriori del parametro così ottenuto è rappresentato nella figura seguente che riporta la densità della distribuzione a posteriori del parametro $p$ = probabilità di osservare "acqua" nell'esperimento casuale del lancio del mappamondo. 
...
```
ovvero 0.6. Quindi, possiamo dire che la probabilità a posteriori che il parametro
assuma un valore compreso tra 0.5 e 0.75 è circa a 0.6.
